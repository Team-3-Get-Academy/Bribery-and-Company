    ...
    return <>
        ...
        <div style="padding: 16px;">
          ...
          <div style="padding: 16px; display: flex; flex-direction: column; gap: 12px;">
            <EmployeeCard name='Benjamin Larsen' title='Chief Executive Officer' img='/benjamin.jpg' desc='Jeg har veldig strevsom med late ansate, se under. Helt ubrukelig, burde kansje banlyse.' />
            <EmployeeCard name='Petter Robin Aarhus' title='Chief Technology Officer'
            desc='Jeg jobber når jeg har lyst...' img='/robin.png' />
            <EmployeeCard name='Jon Fredrik Strømberg' title='Chief Operating Officer' img='/jon.png' desc='Hemmelig Kommentar:(kan bare jeg se denne kommentaren eller er den for alle og se???) Hvorfor gidder jeg å møte opp?.. vil bare ha lønn...'/>
          </div>
        </div>
    </>
  }
